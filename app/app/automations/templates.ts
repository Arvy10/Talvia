...
export const AUTOMATION_TEMPLATES: AutomationTemplate[] = [
  ...
  { id: "email-draft", title: "Brouillon de suivi email", description: "Prépare un brouillon sandbox après un email entrant.", trigger: "Un nouveau message est reçu", channel: "gmail", action: "prepare_draft", event: "message_received" },
];
